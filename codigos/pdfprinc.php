...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $weeksOfTraining = $_GET["weeksOfTraining"];

    // informacion de las rutinas principiante
    $rutinas = array(
        1 => array(
            'Piernas' => array(
    ...
    class tPDF extends tFPDF
    {
        ...
        function Header()
        {
            ...
            $this->SetX(40);
            $this->Cell(0, 10, utf8_decode('Rutina para Principiantes'), 0, 1, 'l');
    ...
    foreach ($rutinas[$weeksOfTraining] as $grupo => $ejercicios) {
        // Título del grupo
