...
<body>
    <main>
        <form action="codigos/pdfinter.php" method="get">
            <div class="container-fluid">
                ...
                <div class="container">
                    ...
                    <select id="monthOfTraining" name="monthOfTraining" class="form-control mb-4 mt-2">
                        <option value="1">6 meses</option>
                        <option value="2">8 meses</option>
                        <option value="3">10 meses</option>
                        <option value="4">15 meses o más</option>
                    </select>
                </div>
    ...
    <script src="codigos/js/intermedio.js"></script>
</body>
